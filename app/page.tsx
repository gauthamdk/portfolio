...
export default function Home() {
  ...
  useEffect(() => {
    const handleEscape = (event: KeyboardEvent) => {
      if (event.key === "Escape" && isConsultationFormOpen) {
    ...
    <main className="min-h-screen bg-[var(--terminal-bg)] text-[var(--terminal-text)] p-2 sm:p-6 max-w-6xl mx-auto">
      ...
      >
        ...
        <div className="mt-6 pt-4 border-t border-gray-700">
          ...
          {isConsultationFormOpen && (
            <div
              className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 consultation-form-modal"
              onClick={(e) => {
            ...
            >
              <div className="flex items-center justify-center min-h-full p-4">
                <div className="bg-gray-900/95 border border-gray-600 rounded-lg w-full max-w-2xl max-h-[85vh] shadow-2xl flex flex-col">
                  <div className="bg-gray-900/95 border-b border-gray-600 p-4 flex items-center justify-between flex-shrink-0">
                    <div className="terminal-prompt-wrapper">
                      <TerminalPrompt>
                        ./consultation --new-project
                      </TerminalPrompt>
                    </div>
                    <button
                    ...
                    <div className="p-6">
                      <div className="command-output">
                        ...
                        <p className="text-sm text-[var(--terminal-muted)] mb-6">
                          Tell me about your project and let&apos;s build
                          something amazing together. All consultations are free
                          and confidential.
                        </p>
